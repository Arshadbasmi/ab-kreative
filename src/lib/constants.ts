...
export const CATEGORIES = [
  ...
  { code: 'FINANCE', name: 'Finance', short: 'Finance', icon: 'CreditCard', color: 'magenta' },
  ...
  { code: 'VIRAL_PRODUCTS', name: 'Viral Products', short: 'Products', icon: 'TrendingUp', color: 'red' },
...
export const SUBCATEGORIES: Record<string, string[]> = {
  ...
  FINANCE: ['Credit Cards', 'Personal Loan', 'Auto Loan', 'Mortgage', 'Business Loan', 'Debt Consolidation', 'Insurance', 'Investment Advisory'],
  ...
  VIRAL_PRODUCTS: ['Amazon Trending', 'Noon Trending', 'TikTok Shop', 'Shopify Trends', 'Dropshipping Winners', 'High-Margin Products', 'Low Competition Products'],
